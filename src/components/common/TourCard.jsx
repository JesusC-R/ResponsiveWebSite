...
function TourCard({ frontClasses, backClasses, frontPictureClasses, 
  frontHeadingClasses, frontHeadingSpanClasses, frontDetailsClasses, 
  heading, details, backCtaClasses, backPriceBoxClasses, backPriceTextClasses,
   backPriceValueClasses, backText, backPrice}) {
  const classes = {
    ...
    frontHeadingSpanClasses: classNames('card__heading-span', frontHeadingSpanClasses),
  ...
  const detailItems = Array.isArray(details) ? details.map((item, index) => (
    ...
    <div className='col-1-of-3'>
      <div className='card'>
        <div className={classes.cardFront}>
          <div className={classes.frontPicture}>
            &nbsp;
          </div>
