    ...
    <section className={props.storiesClasses}>
      ...
      <div className='row'>
        <StoryCard 
          ...
          text={'lorem ipsum dolor sit amet, consectetum lorem ipsum dolor sit amet, consectetum lorem ipsum dolor sit amet, consectetumlorem ipsum dolor sit amet, consectlorem ipsum dolor sit amet, consectetumetum lorem ipsum dolor sit amet, consectetum lorem ipsum dolor sit amet, consectetumlorem ipsum dolor sit amet, consectlorem ipsum dolor sit amet, consectetumetum'}
        ...
        <div className='u-center-text u-margin-top-big'>
            <Button buttonClasses={'btn-text'} href={'#'} text={'Read all stories -->'} />
        </div>        
      </div>
    </section>
  );
